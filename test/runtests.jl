...
@testset "SpeedMapping.jl" begin
	# Testing the complete algorithm with f, g!, ForwardDiff, map!, lower, upper
	...
	# Can't provide both g! and map!
	@test exception(:(speedmapping([0.0, 0.0]; g!, map!)), ArgumentError) 
	# eltype(x_in) is Int
